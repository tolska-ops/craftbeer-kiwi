...
Time estimates are approximate, reconstructed from session content and scope rather than logged timestamps — treat them as ballpark, not precise. At Andy's stated pace of roughly 5-8 hrs/week, total effort to date (approx. 39.5-45 hrs across 23 days) tracks roughly as expected for someone fitting this around a full-time job.
